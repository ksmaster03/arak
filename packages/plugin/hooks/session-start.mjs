...
var LEGAL_BASES, LEGAL_BASIS_LABELS, SENSITIVE_CATEGORIES, GENERAL_CATEGORIES, CATEGORY_LABELS, SENSITIVE_SET;
...
async function main() {
  ...
  const { summarize: summarize2 } = await Promise.resolve().then(() => (init_dist(), dist_exports));
  const root = roots[0];
  const run = loadProject2(root, { today: today2() });
  const summary = summarize2(run.catalog);
  ...
  const context = [
    ...
    "",
    `\u0E2A\u0E16\u0E32\u0E19\u0E30\u0E15\u0E2D\u0E19\u0E19\u0E35\u0E49 \u2014 \u0E21\u0E32\u0E23\u0E4C\u0E01\u0E41\u0E25\u0E49\u0E27 ${summary.marked} \xB7 \u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E15\u0E31\u0E14\u0E2A\u0E34\u0E19 ${summary.unmarked} \xB7 \u0E1E\u0E31\u0E01\u0E44\u0E27\u0E49 ${summary.deferred} \xB7 \u0E44\u0E21\u0E48\u0E43\u0E0A\u0E48 ${summary.notPii}`,
    "",

...
|---|---|
| แคตตาล็อกครอบมาตรา 39 ครบ | ตัวสร้างเอกสาร RoPA (.docx/.xlsx) |
| ตัวอ่าน Prisma พร้อม `@pii` | กฎ Semgrep ที่กันข้อมูลส่วนบุคคลไหลลง log |
| เขียนแคตตาล็อกโดยคอมเมนต์ของคนไม่หาย | MCP server สำหรับอ่านไฟล์แบบปิดบัง |
